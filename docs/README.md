...
Актуальная документация разделена по ролям:
...
- `../SSH_SETUP.md` — подробный runbook по OpenSSH на Windows.
- `../NETBIRD_SETUP.md` — подробный runbook по NetBird.

Если нужна только точка входа в проект, начните с `../README.md`.
